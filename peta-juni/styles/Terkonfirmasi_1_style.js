...
var style_Terkonfirmasi_1 = function(feature, resolution){
    ...
    if (value >= 79.000000 && value <= 187.200000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 187.200000 && value <= 309.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 309.000000 && value <= 771.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 771.600000 && value <= 1828.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1828.600000 && value <= 11805.000000) {
            style = [ new ol.style.Style({
